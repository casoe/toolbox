...
SCRIPT="export-effortsfixed-datev-gb70.sh"
...
exortfileprefix="BCS2DATEV_EffortsFixed_gb70_"
schedulerdef="CSV_DATEV_EffortsFixed_GB7-INFORM-Cronjob"
...
zip -r -m -j -x"*.log" $BCSARCHIV/archiv-ist-sachkosten/$exortfileprefix$FULLDATE-$FULLTIME.zip $BCSEXPORT
#Log file as last
