...
PSQL="psql postgresql://bcs@$DATABASE/ods70"
...
while [  $COUNTER -lt $MONTHS ]; do
	...
	$SCHEDULERCLIENT -t JDBC_ODS70_Efforts "export.param.startdate=$START" "export.param.enddate=$END"
