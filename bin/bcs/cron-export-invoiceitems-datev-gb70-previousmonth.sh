...
SCRIPT="export-invoiceitems-datev-gb70-previousmonth.sh"
BCSHOME="/opt/projektron/bcs/server"
BCSEXPORT="/opt/projektron/bcs/export"
BCSARCHIV="/opt/projektron/bcs/datev"

exortfileprefix="BCS2DATEV_InvoiceItems_VorherigerMonat_gb70_"
schedulerdef="CSV_DATEV_InvoiceItems_GB7_PreviousMonth-INFORM-Cronjob"
